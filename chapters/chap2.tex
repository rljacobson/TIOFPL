...
lambda calculus. The task is to give a value for \evalbb{E}, for every lambda
...
\begin{mlcoded}
    \evalbb{E$_1$ E$_2$} \tr{} $=$ (\evalbb{E$_1$} \tr{}) (\evalbb{E$_2$} \tr{})
\end{mlcoded}
The final case is that of a lambda abstraction. What should be the value of
(\evalbb{\tlb{x. E}} \tr{})? It is certainly a function, and so we can fully define it by
...
Formally, we write
\begin{mlcoded}
    \evalbb{\tlb{x}E} \tr{} a $=$ \evalbb{E} \tr{}[x$=$a]
\end{mlcoded}
...
\boxedfigure{
    \small
\begin{tabular}{ll}
    \evalbb{k} \tr{} & $=$ <see Section 2.5.3> \\
    \evalbb{x} \tr{} & \ml{$=$ \tr{} x} \\
    \evalbb{E$_1$ E$_2$} \tr{} & \ml{$=$ (\evalbb{E$_1$} \tr{})\quad (\evalbb{E$_2$} \tr{})} \\
    \ml{\evalbb{\tlb{x. E}} \tr{} a} & \ml{$=$ \evalbb{E} \tr{}[x=a]}
\end{tabular}
\vs
...
\begin{mlalign}
    \evalbb{E$_1$} & $=$ \evalbb{E$_2$}
\end{mlalign}

where we should more correctly write

\begin{mlalign}
    \evalbb{E$_1$} \tr{} & $=$ \evalbb{E$_2$} \tr{}
\end{mlalign}
...
In this section we will see how to define the value of \evalbb{k}, where \ml{k} is a
...
\begin{mlcoded}
    \evalbb{\tlb{x} + x 1} = \evalbb{\tlb{y}+ y 1}
\end{mlcoded}
